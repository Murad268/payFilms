...
<style>
    ...
    .pagination-wrap ul li {
        display: inline;
        margin-right: 10px; /* Sayfalar arası boşluk */
    }

    .pagination-wrap ul li a {
        color: white; /* Sayfa linklerinin metin rengi */
        text-decoration: none; /* Sayfa linklerinin altı çizili olmaması */
        padding: 5px 10px; /* Sayfa linklerinin içeriğin kenarlıktan uzaklığı */
        background-color: black; /* Sayfa linklerinin arka plan rengi */
        border-radius: 5px; /* Sayfa linklerinin köşe yuvarlama */
    }
    .pagination-wrap ul li.active a {
        background-color: red; /* Aktif sayfanın arka plan rengi */
        color: white; /* Aktif sayfanın metin rengi */
    }

    .pagination-wrap ul li a:hover {
        background-color: darkred; /* Fare üzerine geldiğinde sayfa linklerinin arka plan rengi */
    }
</style>
    <!-- breadcrumb-area -->
