@extends('admin.back')
@section('page_title', 'one serie documentals')
@section('content')
<style>
    .card-body {
        overflow-x: scroll;
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="{{route('admin.oneseriedocumentals.create')}}" class="btn btn-primary">yeni film əlavə et</a>
                            </h3>

                        </div>
                        <div class="card-body">
                            <div class="mt-3">
                                <form action="{{ route('admin.oneseriedocumentals.index') }}" method="GET">
