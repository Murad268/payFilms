                    ...
                    <form method="post" action="{{route('admin.admins.store')}}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="name" value="{{ old('name') }}" type="text" class="form-control" placeholder="Adminin adını daxil edin">
                            </div>
                            @error("name")
                            ...
                            <div class="form-group">
                                ...
                                <input name="surname" value="{{ old('surname') }}" type="text" class="form-control" placeholder="Adminin soy adını daxil edin">
                            </div>
                            @error("surname")
                            <div class="alert alert-danger mt-2" role="alert">
                                {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <input name="login" value="{{ old('login') }}" type="text" class="form-control" placeholder="Adminin loginini daxil edin">
                            </div>
                            @error("login")
                            <div class="alert alert-danger mt-2" role="alert">
                                {{ $message }}
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary">Admini əlavə et</button>
                        </div>
                    </form>
                </div>
            </div>
