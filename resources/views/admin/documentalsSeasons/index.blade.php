@extends('admin.back')
@section('page_title', 'documental seasons')
@section('content')
<style>
    #example2 {
        width: max-content;
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="{{route('admin.documentals.create.new', $serie_id)}}" class="btn btn-primary">yeni sezon əlavə et</a>
                            </h3>
                        </div>
                        <div class="card-body">
                            @if($seasons->count() > 0)
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form style="display: flex; align-items: center; column-gap: 5px" onsubmit="return deleteSeason(event)" class="mt-2" method="post" action="{{route('admin.documentals.seasons.destroy', $season->id)}}">
